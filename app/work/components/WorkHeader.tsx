...
export const WorkHeader = () => {
    ...
    return (
        <div ref={headerRef} className="mt-24 md:mt-[18.06dvh] margin-left margin-right">
            ...
            <h2 ref={titleRef} className="opacity-0 text-right mt-2 lg:mt-[4dvh]">
            ...
            <p ref={subtitleRef} className="opacity-0 text-accent text-[0.55rem] lg:text-xl text-right mt-2 lg:mt-[4dvh]">
