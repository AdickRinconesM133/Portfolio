...
export const About = () => {
    return (
        <div className="flex w-full lg:min-h-dvh h-auto overflow-hidden pb-[15dvh] lg:pb-0">
            <Card className="py-6 lg:py-[8dvh]">
                <div className="mx-4 md:ml-[10.63dvw] md:mr-[10dvw] xl:mr-[30dvw]">
                    ...
                    <p className="text-[0.65rem] md:text-[0.8rem] mt-4 lg:mt-[4dvh]">Software Engineer specializing in Backend Development and Cloud Solutions. Focused on building robust, scalable systems that transform complex business needs into reliable, high-performance applications.</p>
                    <Link href="/about">
                        <p className="mt-4 lg:mt-[4dvh] text-[0.65rem] md:text-[0.8rem]! border border-accent rounded-full px-3 py-1.5 md:px-[0.8vw] md:py-[0.8vh] w-fit">LEARN MORE ABOUT ME</p>
                    </Link>
