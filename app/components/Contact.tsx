...
export const Contact = () => {
    return (
        <div id="contact" className="flex w-full overflow-hidden margin-top pb-[6lvh]">
            <ScrollCardReveal className="w-full">
                <Card className="py-6 lg:py-[8lvh]">
                    <div className="ml-4 mr-4 md:ml-[10.63dvw] md:mr-[30dvw]">
                        ...
                        <h2 className="mt-2 lg:mt-[4lvh] text-[3rem]! md:text-[8rem]!">GOT A <span className="text-accent">PROJECT?</span></h2>
                        <p className="text-[0.65rem] md:text-[0.8rem] mt-4 lg:mt-[4lvh]">TELL ME ABOUT YOUR VISION AND I'LL HELP YOU BRING IT TO LIFE.</p>
                        <div className="flex flex-wrap justify-start gap-3 md:gap-x-[1.75dvw] mt-4 lg:mt-[4lvh]">
                            <Link href="/contact">
